...
const CreditRequest = () => {
  return (
    <>
      <Breadcrumb pageName="Credit Request"  breadcrumbs={[{ name: 'Support /', link: '#' }]} />
        ...
        <form action="#">
          <div className="p-6.5">
            ...
            <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
              <div className="w-full xl:w-1/2">
                <label className="mb-2.5 block text-baseColor dark:text-white">
                  Last Deposite Amount <span className="text-meta-1">*</span>
                </label>
                <input
                  type="text"
                  placeholder="Enter Last Deposite Amount"
                  className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary1 active:border-primary1 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary1"
                />
              </div>
              ...
              <div className="w-full xl:w-1/2">
                <label className="mb-2.5 block text-baseColor dark:text-white">
                  Last Deposite Date <span className="text-meta-1">*</span>
                </label>
                <input
                  type="text"
                  placeholder="Enter Last Deposite Date"
                  className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary1 active:border-primary1 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary1"
                />
              </div>
            </div>
            ...
            <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
              <div className="w-full xl:w-1/2">
                <label className="mb-2.5 block text-baseColor dark:text-white">
                  Credit Amount Needed <span className="text-meta-1">*</span>
                </label>
                <input
                  type="text"
                  placeholder="Enter Credit Amount Needed"
                  className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary1 active:border-primary1 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary1"
                />
              </div>
              ...
              <div className="w-full xl:w-1/2">
                <label className="mb-2.5 block text-baseColor dark:text-white">
                  Credit Already Pending <span className="text-meta-1">*</span>
                </label>
                <input
                  type="text"
                  placeholder="Enter Credit Already Pending"
                  className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary1 active:border-primary1 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary1"
                />
              </div>
            </div>
