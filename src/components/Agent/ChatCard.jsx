...
const ChatCard = () => {
  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
      <h4 className="mb-6 px-7.5 text-xl font-semibold text-baseColor dark:text-white">
        Chats
      </h4>
      ...
      <div>
        ...
        >
          ...
          <div className="flex flex-1 items-center justify-between">
            <div>
              <h5 className="font-medium text-baseColor dark:text-white">
                Devid Heilo
              </h5>
              <p>
                <span className="text-sm text-baseColor dark:text-white">
                  Hello, how are you?
                </span>
