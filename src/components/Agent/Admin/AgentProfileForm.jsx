const AgentProfileForm = () => {
  return (
    <>
      ...
      {/* <!-- Contact Form --> */}
      <div className="rounded-sm border border-stroke mt-7 bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <form action="#">
          <div className="p-6.5">
            ...
            <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
              <div className="w-full xl:w-1/2">
                <label className="mb-2.5 block text-baseColor dark:text-white">
                  Fax <span className="text-meta-1">*</span>
                </label>
                <input
                  type="text"
                  placeholder="fax"
            ...
            <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
              <div className="w-full xl:w-1/2">
                <label className="mb-2.5 block text-baseColor dark:text-white">
                  Facebook Link <span className="text-meta-1">*</span>
                </label>
                <input
                  type="text"
