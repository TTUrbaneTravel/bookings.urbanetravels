...
import AgentProfileForm from './Admin/AgentProfileForm';

const Profile = () => {
  return (
    <>
      <Breadcrumb pageName="Agent Profile"  breadcrumbs={[{ name: 'Admin /', link: '#' }]} />
      ...
      dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65">
          ...
          <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
            <label
              htmlFor="cover"
              className="flex cursor-pointer items-center justify-center gap-2 rounded bg-primary1 py-1 px-2 
              text-sm font-medium text-white hover:bg-opacity-80 xsm:px-4"
            >
        ...
        <div className="px-4 pb-6  lg:pb-8 xl:pb-11.5">
          <div className="relative text-center z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img src={userSix} alt="profile" />
              <label
                htmlFor="profile"
                className="absolute bottom-0 right-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-primary1 text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
              >
                <svg
                  className="fill-current"
                  width="14"
          ...
          <div className="mt-4">
            <h3 className="mb-1.5 text-center text-2xl font-semibold text-baseColor dark:text-white">
              Urbane Travel LLP
            </h3>
            <p className="font-medium text-center">URBANEIN39489169</p>

            {/* <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-semibold text-baseColor dark:text-white">
                  259
                </span>
            ...
            <div className="mx-auto max-w-180">
              <h4 className="font-semibold text-baseColor dark:text-white">
                About Me
              </h4>
              <p className="mt-4.5">
            ...
            <div className="mt-6.5">
              <h4 className="mb-3.5 font-medium text-baseColor dark:text-white">
                Follow me on
              </h4>
