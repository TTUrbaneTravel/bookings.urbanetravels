        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-baseColor dark:text-white sm:text-title-xl2">
                Sign Up to Agent
              </h2>

              <form>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium text-baseColor dark:text-white">
                    Name
                  </label>
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary1 focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary1"
                    />
                ...
                <div className="mb-5">
                  <input
                    ...
                    className="w-full cursor-pointer rounded-lg border border-primary1 bg-primary1 p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to="/auth/signin" className="text-primary1">
                      Sign in
                    </Link>
                  </p>
                </div>
